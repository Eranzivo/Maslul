Read the following files in order, then confirm your understanding:

1. Read `CLAUDE.md` (working rules, architecture principles, invariants)
...
- The single most important scheduling rule not to break
- What the current tech stack is

Do not start any task or write any code yet. Just confirm you're fully loaded and ready.
