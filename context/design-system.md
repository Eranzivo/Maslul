...
- **Weekly combined view is the standard (Eran 2026-07-12):** tech picker 1→all, all selected calls overlaid in ONE grid, per-tech color+tag+details, "render on each other nice and styled, without breaking logic". Approved mockup: calendar artifact e7c04323 (interactive picker). **Port QA rule: every screen with daily/weekly views must render BOTH properly after any calendar change.**
