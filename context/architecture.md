...
- Roadmap (design `outputs/geo-selfheal-design_2026-07-14.md`): Slice 3 door wiring → Slice 4 add-city→zone flow → Slice 5 small-settlement seeding. Learned aliases stay **approval-gated** (doctrine).
